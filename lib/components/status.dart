...
import 'package:bank_app/themes/theme_colors.dart';
...
class _AccountStatusState extends State<AccountStatus> {
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        '\$${BankInherited.of(context).spent}',
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        '\$${BankInherited.of(context).earned}',
                        style: Theme.of(context).textTheme.bodyLarge,
                      ),
                    ],
                  ),
              ...
              Expanded(
                child: Container(
                  ...
                  child: LinearProgressIndicator(
                    value: BankInherited.of(context).spent / 1000,
  ...
  double spentAndEarned() {
    double result =
        (BankInherited.of(context).spent / BankInherited.of(context).earned) *
            100;
    if (result.isNaN) {
      return 0;
    }
